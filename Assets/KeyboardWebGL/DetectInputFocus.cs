...
namespace WebGLKeyboard
{
    ...
    public class DetectInputFocus : MonoBehaviour, IPointerClickHandler, IDeselectHandler
    {
        ...
        void Update()
        {
            if (this.nativeInput == null || this.controller == null)
            {
                return;
            }
            ...
            if (this.controller.currentNativeInput != null)
            {
                if (this.controller.currentNativeInput.GetInstanceID() == nativeInput.GetInstanceID())
                {
                    this.nativeInput.text = this.controller.inputString;
                }
            }
        }
